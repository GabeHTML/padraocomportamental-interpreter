...
public class InterpretadorPrecoRemedio implements InterpretadorPreco{
    private InterpretadorPreco interpretadorInicial;

    public InterpretadorPrecoRemedio(String contexto) {
        ...
        while (iterator.hasNext()) {
            ...
            if (elemento.matches("\\d+(\\.\\d*)?")) {
                ...
                if (!iterator.hasNext())
                    throw new IllegalArgumentException("Remédio inválido");
                ...
                throw new IllegalArgumentException("Remédio com elemento inválido");
            }
        }
